...
def new_post(producto, varchar, existencias, precio_compra, precio_venta,imagen):
    db.insert('productos', producto=producto, descripcion=varchar, existencias=existencias, precio_compra=precio_compra, precio_venta=precio_venta, imagen=imagen, posted_on=datetime.datetime.utcnow())
